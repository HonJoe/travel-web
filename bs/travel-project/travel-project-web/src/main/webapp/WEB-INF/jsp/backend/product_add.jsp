    ...
    <div class="rt_content">
        ...
        <form class="form-horizontal" role="form" onsubmit="return false;" id="form1">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="title" name="title" placeholder="产品标题" required="required">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" id="price" name="price" placeholder="产品价格" onkeyup="clearNoNum(this)" required="required"/>
                </div>
            </div>
            <div class="form-group">
                <label  class="col-sm-2 control-label">出发地</label>
                <div class="col-sm-3">
                    <input type="text" id="startAreaname" class="form-control" name="startAreaname" required="required" >
                </div>
            </div>
            <div class="form-group">
                <label  class="col-sm-2 control-label">目的地</label>
                <div class="col-sm-3">
                    <input type="text" id="endAreaname" class="form-control" name="endAreaname" required="required" >
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input type="text" class="form-control" id="activeDays" name="activeDays"  required="required" onkeyup="clearNoNum(this)"/>
                </div>
            </div>
            <div class="form-group">
                ...
                <c:forEach items="${theme}" var="key">
                    <label class="checkbox-inline">
                        <input type="checkbox" name="themeName"  value="${key.themeName}">${key.themeName}
                    </label>
                </c:forEach>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <label class="radio-inline">
                        <input type="radio" name="status" id="inlineRadio2" value="2" checked> 否
                    </label>
                </div>
            </div>
